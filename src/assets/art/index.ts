...
import a_bg_dark_mobile_640 from "./bg-dark-mobile-640.webp.asset.json";
import a_bg_dark_mobile_853 from "./bg-dark-mobile-853.webp.asset.json";
...
import a_bg_light_mobile_640 from "./bg-light-mobile-640.webp.asset.json";
import a_bg_light_mobile_853 from "./bg-light-mobile-853.webp.asset.json";
...
export const ART = {
  "bg-dark-mobile": {
    srcset: `${a_bg_dark_mobile_640.url} 640w` + ", " + `${a_bg_dark_mobile_853.url} 853w`,
    src: a_bg_dark_mobile_853.url,
    width: 853, height: 1844,
    blur: "data:image/webp;base64,UklGRmQAAABXRUJQVlA4IFgAAAAQBACdASoQACMAPt1epU2opaOiNUgBEBuJYwDIBIjDhYY9LPsYMn9VwAD+73R91HswBK5EF9ud2w0GpVpzI5fkMLJCLyOjD1kQrC9K32LESG9BKKGkgAAA",
  },
  "bg-dark-web": {
  ...
  "bg-light-mobile": {
    srcset: `${a_bg_light_mobile_640.url} 640w` + ", " + `${a_bg_light_mobile_853.url} 853w`,
    src: a_bg_light_mobile_853.url,
    width: 853, height: 1844,
    blur: "data:image/webp;base64,UklGRlwAAABXRUJQVlA4IFAAAADwAwCdASoQACMAPulgqE2pJaOiNVgIASAdCWIAALkWmFbet1lDhyQAAP7oppJyBJov+1fpnPX7h3fSZae1/t5F9klSkLfNKoqpac95q3wIAA==",
  },
  "bg-light-web": {
