      ...
      <div className="w-full max-w-[420px] border border-border rounded-md p-8 space-y-6">
        ...
        {mode === "update_password" ? (
          <form onSubmit={handleUpdatePassword} className="space-y-4">
            <h2 className="text-[16px] font-semibold text-center mb-4">Update Password</h2>
            <div className="space-y-1">
              <Label className="text-[12px]">New Password</Label>
              <Input type="password" placeholder="Min 6 characters" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required minLength={6} className="h-8 text-[13px]" />
            </div>
          ...
          <form onSubmit={handleForgotPassword} className="space-y-4">
            <h2 className="text-[16px] font-semibold text-center mb-4">Reset Password</h2>
            <div className="space-y-1">
              <Label className="text-[12px]">Email</Label>
              <Input type="email" placeholder="you@example.com" value={resetEmail} onChange={(e) => setResetEmail(e.target.value)} required className="h-8 text-[13px]" />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <Button type="button" variant="ghost" className="h-8 text-[12px]" onClick={() => setMode("auth")} disabled={isSubmitting}>
                Back to Sign in
              </Button>
            </div>
          </form>
              ...
              <form onSubmit={handleLogin} className="space-y-3">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <button type="button" onClick={() => setMode("forgot_password")} className="text-[11px] text-muted-foreground hover:text-foreground">Forgot password?</button>
                  </div>
