    ...
    <AppLayout>
      ...
      <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="border border-border rounded-md">
          ...
          accounts.length === 0 ? <div className="p-6 text-center text-[13px] text-muted-foreground">No accounts yet.</div> :
          <ul>
            {accounts.map(a => (
              <li key={a.id} className="flex items-center gap-3 px-4 h-11 border-b border-border last:border-b-0 text-[13px]">
